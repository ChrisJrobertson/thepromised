    ...
    Tables: {
      ...
      seo_organisation_pages: {
        Row: {
          ...
          common_issues: Json;
          ombudsman_name: string | null;
          ombudsman_slug: string | null;
          regulator_name: string | null;
          primary_legislation: string[] | null;
          complaint_deadline_days: number | null;
          related_guide_slugs: string[] | null;
          related_org_slugs: string[] | null;
          status: string;
...
export type SeoOrganisationPage =
  Database["public"]["Tables"]["seo_organisation_pages"]["Row"];
export type SeoGuidePage = Database["public"]["Tables"]["seo_guide_pages"]["Row"];
